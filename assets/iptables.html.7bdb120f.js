import{_ as s}from"./plugin-vue_export-helper.21dcd24c.js";import{o as n,c as e,d as a}from"./app.72cd900d.js";const i={},l=a(`<h1 id="iptables" tabindex="-1"><a class="header-anchor" href="#iptables" aria-hidden="true">#</a> iptables</h1><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token comment">#1.\u5F00\u542F\u4E00\u4E2Assh\u7AEF\u53E3</span>
...
iptables <span class="token parameter variable">-I</span> INPUT <span class="token parameter variable">-s</span> <span class="token number">14.23</span>.97.250 <span class="token parameter variable">-p</span> tcp <span class="token parameter variable">--dport</span> <span class="token number">22</span> <span class="token parameter variable">-j</span> ACCEPT
...
iptables <span class="token parameter variable">-I</span> INPUT <span class="token parameter variable">-s</span> <span class="token number">14.23</span>.97.250,192.168.2.0/24 <span class="token parameter variable">-p</span> tcp <span class="token parameter variable">--dport</span> <span class="token number">60011</span> <span class="token parameter variable">-j</span> ACCEPT
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>iptables -A INPUT -i 14.23.97.250 -p tcp --dport 80 -j ACCEPT</p><p>iptables -A INPUT -i 14.23.97.250 -p tcp --dport 443 -j ACCEPT</p><h3 id="\u670D\u52A1\u5668\u5904\u7406" tabindex="-1"><a class="header-anchor" href="#\u670D\u52A1\u5668\u5904\u7406" aria-hidden="true">#</a> \u670D\u52A1\u5668\u5904\u7406</h3><ol><li>\u9650\u5236\u767B\u9646ip\u53EA\u670914.23.97.250\u624D\u80FD\u767B\u9646</li><li>\u9632\u706B\u5899\u9650\u5236\u8BBF\u95EE\u5916\u7F51ip</li><li>\u4FEE\u6539\u9ED8\u8BA4ssh\u7AEF\u53E3\u4E3A60011</li><li>\u4FEE\u6539\u5168\u90E8\u8D26\u53F7\u5BC6\u7801\uFF0Croot\u3001jobui\u53CA\u4E2A\u4EBA\u8D26\u53F7\uFF0C\u5220\u9664\u53EF\u7591\u8D26\u53F7</li></ol>`,11),p=[l];function c(r,t){return n(),e("div",null,p)}var m=s(i,[["render",c],["__file","iptables.html.vue"]]);export{m as default};
