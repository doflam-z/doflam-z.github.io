import{_ as t}from"./plugin-vue_export-helper.21dcd24c.js";import{o as i,c as l,a as n,b as o,e as a,d as s,r as p}from"./app.5cc063ec.js";const c={},u=a(`<h1 id="mongo" tabindex="-1"><a class="header-anchor" href="#mongo" aria-hidden="true">#</a> mongo</h1><h3 id="docker\u521B\u5EFAmongo\u96C6\u7FA4" tabindex="-1"><a class="header-anchor" href="#docker\u521B\u5EFAmongo\u96C6\u7FA4" aria-hidden="true">#</a> docker\u521B\u5EFAmongo\u96C6\u7FA4</h3><div class="language-yaml ext-yml line-numbers-mode"><pre class="language-yaml"><code><span class="token key atrule">version</span><span class="token punctuation">:</span> <span class="token string">&#39;3.1&#39;</span>
...
<span class="token key atrule">services</span><span class="token punctuation">:</span>
  <span class="token key atrule">mongodb</span><span class="token punctuation">:</span>
    ...
    <span class="token key atrule">hostname</span><span class="token punctuation">:</span> mongodb
    <span class="token key atrule">restart</span><span class="token punctuation">:</span> always
    <span class="token key atrule">ports</span><span class="token punctuation">:</span>
      <span class="token punctuation">-</span> 14000<span class="token punctuation">:</span><span class="token number">27017</span>
    <span class="token key atrule">volumes</span><span class="token punctuation">:</span>
      <span class="token punctuation">-</span> ./data/db<span class="token punctuation">:</span>/data/db
      <span class="token punctuation">-</span> ./logs/mongo<span class="token punctuation">:</span>/var/log/mongodb
    ...
    <span class="token key atrule">environment</span><span class="token punctuation">:</span>
      <span class="token key atrule">MONGO_INITDB_REPLSET</span><span class="token punctuation">:</span> jobui_mongodb
      <span class="token key atrule">TZ</span><span class="token punctuation">:</span> Asia/Shanghai
    <span class="token key atrule">command</span><span class="token punctuation">:</span> <span class="token punctuation">[</span><span class="token string">&quot;--replSet&quot;</span><span class="token punctuation">,</span> <span class="token string">&quot;jobui_mongodb&quot;</span><span class="token punctuation">,</span> <span class="token string">&quot;--logpath&quot;</span><span class="token punctuation">,</span> <span class="token string">&quot;/var/log/mongodb/mongo.log&quot;</span><span class="token punctuation">]</span>
...
rs.initiate<span class="token punctuation">(</span><span class="token punctuation">{</span>  _id: <span class="token string">&quot;jobui&quot;</span>,  members: <span class="token punctuation">[</span>    <span class="token punctuation">{</span> _id: <span class="token number">0</span>, host: <span class="token string">&quot;192.168.1.55:27017&quot;</span>, priority: <span class="token number">2</span> <span class="token punctuation">}</span>,    <span class="token punctuation">{</span> _id: <span class="token number">1</span>, host: <span class="token string">&quot;192.168.1.39:27017&quot;</span>, priority: <span class="token number">1</span> <span class="token punctuation">}</span>,    <span class="token punctuation">{</span> _id: <span class="token number">2</span>, host: <span class="token string">&quot;192.168.1.39:27018&quot;</span>, arbiterOnly: <span class="token boolean">true</span> <span class="token punctuation">}</span>  <span class="token punctuation">]</span>,  settings: <span class="token punctuation">{</span>    chainingAllowed: true,    heartbeatIntervalMillis: <span class="token number">2000</span>,    electionTimeoutMillis: <span class="token number">10000</span>  <span class="token punctuation">}</span> <span class="token punctuation">}</span><span class="token punctuation">)</span>
...
mongodump <span class="token parameter variable">-h</span> <span class="token number">192.168</span>.1.35:12000 <span class="token parameter variable">-d</span> jobui_tmp <span class="token parameter variable">-o</span> /ssd_data/mongobackups/
or
...
<span class="token comment">## \u7B2C\u4E00\u6B21\u5168\u91CF\u5BFC\u51FA</span>
<span class="token comment"># 1. \u4ECE3.0\u96C6\u7FA4\u5BFC\u51FA\u5168\u91CF\u6570\u636E\uFF08\u4E0D\u9501\u5E93\uFF0C\u4ECEsecondary\u8BFB\u53D6\uFF09</span>
mongodump <span class="token parameter variable">--host</span> rs0/secondary:27017 <span class="token punctuation">\\</span>
  <span class="token parameter variable">--oplog</span> <span class="token punctuation">\\</span>
  <span class="token parameter variable">--gzip</span> <span class="token punctuation">\\</span>
  <span class="token parameter variable">--out</span><span class="token operator">=</span>/backup/full

<span class="token comment"># 2. \u5BFC\u5165\u52306.0\u96C6\u7FA4\uFF08\u5305\u542Boplog\u56DE\u653E\uFF09</span>
mongorestore <span class="token parameter variable">--host</span> rs1/primary:27017 <span class="token punctuation">\\</span>
  <span class="token parameter variable">--oplogReplay</span> <span class="token punctuation">\\</span>
  <span class="token parameter variable">--gzip</span> <span class="token punctuation">\\</span>
  <span class="token parameter variable">--dir</span><span class="token operator">=</span>/backup/full
  
<span class="token comment">## \u7B2C\u4E8C\u6B21\u589E\u91CF\u5BFC\u51FA</span>
<span class="token comment"># 1. \u8BB0\u5F55\u5168\u91CF\u5BFC\u51FA\u7ED3\u675F\u65F6\u7684oplog\u4F4D\u7F6E</span>
<span class="token function">tail</span> <span class="token parameter variable">-n</span> <span class="token number">1</span> /backup/full/oplog.bson <span class="token operator">|</span> bsondump <span class="token operator">|</span> jq <span class="token string">&#39;.ts&#39;</span>

<span class="token comment"># \u8F93\u51FA\u793A\u4F8B\uFF08\u8BB0\u4E0B\u6B64\u503C\uFF09\uFF1A</span>
<span class="token comment"># { &quot;ts&quot;: { &quot;$timestamp&quot;: { &quot;t&quot;: 1710000000, &quot;i&quot;: 1 } } }</span>

<span class="token comment"># 2. \u6267\u884C\u589E\u91CF\u5BFC\u51FA\uFF08\u4EC5\u5BFC\u51FA\u6B64\u65F6\u95F4\u70B9\u4E4B\u540E\u7684\u53D8\u66F4\uFF09</span>
mongodump <span class="token parameter variable">--host</span> rs0/primary:27017 <span class="token punctuation">\\</span>
  <span class="token parameter variable">--oplog</span> <span class="token punctuation">\\</span>
  <span class="token parameter variable">--gzip</span> <span class="token punctuation">\\</span>
  <span class="token parameter variable">--query</span><span class="token operator">=</span><span class="token string">&#39;{&quot;ts&quot;: {&quot;$gt&quot;: {&quot;$timestamp&quot;: {&quot;t&quot;: 1710000000, &quot;i&quot;: 1}}}}&#39;</span> <span class="token punctuation">\\</span>
  <span class="token parameter variable">--out</span><span class="token operator">=</span>/backup/incremental

<span class="token comment"># 3. \u5BFC\u5165\u589E\u91CF\u6570\u636E\u52306.0\u96C6\u7FA4</span>
mongorestore <span class="token parameter variable">--host</span> rs1/primary:27017 <span class="token punctuation">\\</span>
  <span class="token parameter variable">--oplogReplay</span> <span class="token punctuation">\\</span>
  <span class="token parameter variable">--gzip</span> <span class="token punctuation">\\</span>
  <span class="token parameter variable">--dir</span><span class="token operator">=</span>/backup/incremental
