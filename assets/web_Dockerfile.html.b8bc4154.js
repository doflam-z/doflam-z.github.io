import{_ as n}from"./plugin-vue_export-helper.21dcd24c.js";import{o as s,c as a,e as p}from"./app.67c6bce0.js";const e={},i=p(`<h1 id="dockerfile\u7F16\u5199" tabindex="-1"><a class="header-anchor" href="#dockerfile\u7F16\u5199" aria-hidden="true">#</a> dockerfile\u7F16\u5199</h1><h3 id="debian10\u57FA\u7840\u955C\u50CF" tabindex="-1"><a class="header-anchor" href="#debian10\u57FA\u7840\u955C\u50CF" aria-hidden="true">#</a> debian10\u57FA\u7840\u955C\u50CF</h3><div class="language-docker ext-docker line-numbers-mode"><pre class="language-docker"><code><span class="token instruction"><span class="token keyword">FROM</span> debian:buster-slim</span>
...
<span class="token instruction"><span class="token keyword">WORKDIR</span> /web/php/projectPHP/</span>
...
<span class="token instruction"><span class="token keyword">RUN</span> apt-get update -y &amp;&amp; <span class="token operator">\\</span>
   ...
   libdatrie-dev libmcrypt-dev procps nfs-common &amp;&amp; apt-get clean; <span class="token operator">\\</span>
    rm -rf /var/lib/apt/lists/* /tmp/* /var/tmp/* /usr/share/doc/*</span>
...
<span class="token instruction"><span class="token keyword">RUN</span> cd /usr/local/src/docker/php/php-7.4.24/ &amp;&amp; <span class="token operator">\\</span>
   ./configure <span class="token operator">\\</span>
    ...
    --enable-maintainer-zts <span class="token operator">\\</span>
    --without-pear <span class="token operator">\\</span>
    --enable-fpm &amp;&amp; <span class="token operator">\\</span>
    make &amp;&amp; make install <span class="token operator">\\</span>
<span class="token comment"># apcu</span>
    &amp;&amp; cd /usr/local/src/docker/php/package/apcu-5.1.21 <span class="token operator">\\</span>
    &amp;&amp; /web/software/php-7.4.24/bin/phpize <span class="token operator">\\</span>
    &amp;&amp; ./configure --with-php-config=/web/software/php-7.4.24/bin/php-config <span class="token operator">\\</span>
    &amp;&amp; make &amp;&amp; make install <span class="token operator">\\</span>
<span class="token comment"># blitz</span>
    &amp;&amp; cd /usr/local/src/docker/php/package/blitz-0.10.4-PHP7/ <span class="token operator">\\</span>
    &amp;&amp; /web/software/php-7.4.24/bin/phpize <span class="token operator">\\</span>
    &amp;&amp; ./configure --with-php-config=/web/software/php-7.4.24/bin/php-config <span class="token operator">\\</span>
    &amp;&amp; make &amp;&amp; make install <span class="token operator">\\</span>
<span class="token comment"># memcached</span>
    &amp;&amp; cd /usr/local/src/docker/php/package/memcached-3.2.0 <span class="token operator">\\</span>
    &amp;&amp; /web/software/php-7.4.24/bin/phpize <span class="token operator">\\</span>
    &amp;&amp; ./configure --with-php-config=/web/software/php-7.4.24/bin/php-config <span class="token operator">\\</span>
    &amp;&amp; make &amp;&amp; make install <span class="token operator">\\</span>
<span class="token comment"># memcache</span>
    &amp;&amp; cd /usr/local/src/docker/php/package/memcache-4.0.5.2 <span class="token operator">\\</span>
    &amp;&amp; /web/software/php-7.4.24/bin/phpize <span class="token operator">\\</span>
    &amp;&amp; ./configure --with-php-config=/web/software/php-7.4.24/bin/php-config <span class="token operator">\\</span>
    &amp;&amp; make &amp;&amp; make install <span class="token operator">\\</span>
<span class="token comment"># mongodb</span>
    &amp;&amp; cd /usr/local/src/docker/php/package/mongodb-1.10.0 <span class="token operator">\\</span>
    &amp;&amp; /web/software/php-7.4.24/bin/phpize <span class="token operator">\\</span>
    &amp;&amp; ./configure --with-php-config=/web/software/php-7.4.24/bin/php-config <span class="token operator">\\</span>
    &amp;&amp; make &amp;&amp; make install <span class="token operator">\\</span>
<span class="token comment"># igbinary</span>
    &amp;&amp; cd /usr/local/src/docker/php/package/igbinary-3.2.6 <span class="token operator">\\</span>
    &amp;&amp; /web/software/php-7.4.24/bin/phpize <span class="token operator">\\</span>
    &amp;&amp; ./configure --with-php-config=/web/software/php-7.4.24/bin/php-config <span class="token operator">\\</span>
    &amp;&amp; make &amp;&amp; make install <span class="token operator">\\</span>
<span class="token comment"># redis</span>
    &amp;&amp; cd /usr/local/src/docker/php/package/redis-4.3.0 <span class="token operator">\\</span>
    &amp;&amp; /web/software/php-7.4.24/bin/phpize <span class="token operator">\\</span>
    &amp;&amp; ./configure --with-php-config=/web/software/php-7.4.24/bin/php-config <span class="token operator">\\</span>
    &amp;&amp; make &amp;&amp; make install <span class="token operator">\\</span>
<span class="token comment"># imagick</span>
    &amp;&amp; cd /usr/local/src/docker/php/package/imagick-3.5.1 <span class="token operator">\\</span>
    &amp;&amp; /web/software/php-7.4.24/bin/phpize <span class="token operator">\\</span>
    &amp;&amp; ./configure --with-php-config=/web/software/php-7.4.24/bin/php-config <span class="token operator">\\</span>
    &amp;&amp; make &amp;&amp; make install <span class="token operator">\\</span>
<span class="token comment"># qqwry</span>
   &amp;&amp; cd /usr/local/src/docker/php/package <span class="token operator">\\</span>
    &amp;&amp; cd /usr/local/src/docker/php/package/qqwry-master/php/qqwry/ <span class="token operator">\\</span>
    &amp;&amp; /web/software/php-7.4.24/bin/phpize <span class="token operator">\\</span>
    &amp;&amp; ./configure --with-php-config=/web/software/php-7.4.24/bin/php-config <span class="token operator">\\</span>
    &amp;&amp; make &amp;&amp; make install <span class="token operator">\\</span>
<span class="token comment"># xhprof</span>
    &amp;&amp; cd /usr/local/src/docker/php/package/xhprof-2.3.4/extension/ <span class="token operator">\\</span>
    &amp;&amp; /web/software/php-7.4.24/bin/phpize <span class="token operator">\\</span>
    &amp;&amp; ./configure --with-php-config=/web/software/php-7.4.24/bin/php-config <span class="token operator">\\</span>
    &amp;&amp; make &amp;&amp; make install <span class="token operator">\\</span>
<span class="token comment"># php-ext-trie-filter</span>
    &amp;&amp; cd /usr/local/src/docker/php/package/php-ext-trie-filter-php7 <span class="token operator">\\</span>
    &amp;&amp; /web/software/php-7.4.24/bin/phpize <span class="token operator">\\</span>
    &amp;&amp; ./configure --with-php-config=/web/software/php-7.4.24/bin/php-config <span class="token operator">\\</span>
    &amp;&amp; make &amp;&amp; make install <span class="token operator">\\</span>
<span class="token comment"># scws</span>
    &amp;&amp; cd /usr/local/src/docker/php/package/scws-1.2.3/ <span class="token operator">\\</span>
    &amp;&amp; ./configure --prefix=/web/software/scws-1.2.3/ <span class="token operator">\\</span>
    &amp;&amp; make &amp;&amp; make install <span class="token operator">\\</span>
    &amp;&amp; cp -r /usr/local/src/docker/php/package/dict* /web/software/scws-1.2.3/etc/ <span class="token operator">\\</span>
<span class="token comment"># scws-phpext</span>
    &amp;&amp; cd /usr/local/src/docker/php/package/scws-1.2.3/phpext <span class="token operator">\\</span>
    &amp;&amp; /web/software/php-7.4.24/bin/phpize <span class="token operator">\\</span>
    &amp;&amp; ./configure --with-scws=/web/software/scws-1.2.3 --with-php-config=/web/software/php-7.4.24/bin/php-config <span class="token operator">\\</span>
    &amp;&amp; make &amp;&amp; make install <span class="token operator">\\</span>
<span class="token comment"># mcrypt</span>
    &amp;&amp; cd /usr/local/src/docker/php/package/mcrypt-1.0.4 <span class="token operator">\\</span>
    &amp;&amp; /web/software/php-7.4.24/bin/phpize <span class="token operator">\\</span>
    &amp;&amp; aclocal <span class="token operator">\\</span>
    &amp;&amp; ./configure --with-php-config=/web/software/php-7.4.24/bin/php-config <span class="token operator">\\</span>
    &amp;&amp; make &amp;&amp; make install <span class="token operator">\\</span>
<span class="token comment"># xdebug</span>
    &amp;&amp; cd /usr/local/src/docker/php/package/xdebug-3.1.3 <span class="token operator">\\</span>
    &amp;&amp; /web/software/php-7.4.24/bin/phpize <span class="token operator">\\</span>
    &amp;&amp; ./configure --with-php-config=/web/software/php-7.4.24/bin/php-config <span class="token operator">\\</span>
    &amp;&amp; make &amp;&amp; make install <span class="token operator">\\</span>
<span class="token comment"># parallel</span>
    &amp;&amp; cd /usr/local/src/docker/php/package/parallel-1.1.4 <span class="token operator">\\</span>
    &amp;&amp; /web/software/php-7.4.24/bin/phpize <span class="token operator">\\</span>
    &amp;&amp; ./configure --with-php-config=/web/software/php-7.4.24/bin/php-config <span class="token operator">\\</span>
    &amp;&amp; make &amp;&amp; make install <span class="token operator">\\</span>
<span class="token comment"># gd</span>
    &amp;&amp; cd /usr/local/src/docker/php/php-7.4.24/ext/gd <span class="token operator">\\</span>
    &amp;&amp; /web/software/php-7.4.24/bin/phpize <span class="token operator">\\</span>
    &amp;&amp; ./configure -with-php-config=/web/software/php-7.4.24/bin/php-config --enable-gd --with-jpeg --with-freetype <span class="token operator">\\</span>
    &amp;&amp; make &amp;&amp; make install <span class="token operator">\\</span>
    &amp;&amp; rm -rf /usr/local/src/docker/php/*</span>

<span class="token instruction"><span class="token keyword">COPY</span> php7/conf/php-fpm.conf /web/software/php-7.4.24/etc/php-fpm.conf</span>

<span class="token instruction"><span class="token keyword">COPY</span> php7/conf/php.ini /web/software/php-7.4.24/lib/php.ini</span>

<span class="token instruction"><span class="token keyword">COPY</span> php7/conf/php-fpm /etc/init.d/php-fpm</span>
...
<span class="token instruction"><span class="token keyword">ENTRYPOINT</span> cd /root; ./start.sh</span>
...
<span class="token key atrule">services</span><span class="token punctuation">:</span>
  <span class="token key atrule">fpm</span><span class="token punctuation">:</span>
   <span class="token key atrule">image</span><span class="token punctuation">:</span> php7.4<span class="token punctuation">:</span><span class="token number">1.2</span>
   ...
   <span class="token key atrule">volumes</span><span class="token punctuation">:</span>
      ...
      <span class="token punctuation">-</span> ./docker/php/php7/conf/php<span class="token punctuation">-</span>fpm.conf<span class="token punctuation">:</span>/web/software/php<span class="token punctuation">-</span>7.4.24/etc/php<span class="token punctuation">-</span>fpm.conf
      <span class="token punctuation">-</span> ./docker/php/php7/conf/php.ini<span class="token punctuation">:</span>/web/software/php<span class="token punctuation">-</span>7.4.24/lib/php.ini
  ...
  <span class="token key atrule">nginx</span><span class="token punctuation">:</span>
   <span class="token key atrule">image</span><span class="token punctuation">:</span> nginx<span class="token punctuation">:</span><span class="token number">1.2</span>
...
<span class="token comment">#  redis:</span>
<span class="token comment">#   image: redis:5.0.14</span>
<span class="token comment">#   container_name: redis</span>
...
<span class="token comment">#       ipv4_address: 192.168.10.4</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="supervisor\u955C\u50CF" tabindex="-1"><a class="header-anchor" href="#supervisor\u955C\u50CF" aria-hidden="true">#</a> supervisor\u955C\u50CF</h3><div class="language-docker ext-docker line-numbers-mode"><pre class="language-docker"><code><span class="token instruction"><span class="token keyword">FROM</span> doflamingozzz/php7_line:1.0</span>
<span class="token instruction"><span class="token keyword">RUN</span> apt-get update -y &amp;&amp; <span class="token operator">\\</span>
	apt install supervisor cron -y &amp;&amp; service cron start</span>
<span class="token instruction"><span class="token keyword">RUN</span> tee /etc/supervisor/supervisord.conf &lt;&lt;-<span class="token string">&#39;EOF&#39;</span></span>
...
EOF
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,24),o=[i];function t(l,c){return s(),a("div",null,o)}var d=n(e,[["render",t],["__file","web_Dockerfile.html.vue"]]);export{d as default};
