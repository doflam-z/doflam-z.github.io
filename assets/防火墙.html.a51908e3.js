import{_ as s}from"./plugin-vue_export-helper.21dcd24c.js";import{o as a,c as n,e}from"./app.38570110.js";const i={},l=e(`<h1 id="\u9632\u706B\u5899" tabindex="-1"><a class="header-anchor" href="#\u9632\u706B\u5899" aria-hidden="true">#</a> \u9632\u706B\u5899</h1><h3 id="firewalld" tabindex="-1"><a class="header-anchor" href="#firewalld" aria-hidden="true">#</a> Firewalld</h3><blockquote><p>firewalld\u9ED8\u8BA4\u662F\u5173\u95ED\u6240\u6709\u7AEF\u53E3</p></blockquote><p>\u5F00\u542Ffirewalld\u9632\u706B\u5899</p><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code>systemctl start firewalld.service       <span class="token comment">#\u505C\u6B62firewall</span>
systemctl <span class="token builtin class-name">enable</span> firewalld.service     <span class="token comment">#\u7981\u6B62firewall\u5F00\u673A\u542F\u52A8</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>\u5F00\u542F\u7AEF\u53E3</p><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token comment">#\u76F4\u63A5\u5F00\u653E\u7AEF\u53E3</span>
...
<span class="token comment">#\u5F00\u653E\u6307\u5B9Aip\u6BB5\u8BBF\u95EE\u6307\u5B9A\u7AEF\u53E3</span>
<span class="token function">sudo</span> firewall-cmd <span class="token parameter variable">--permanent</span> --add-rich-rule<span class="token operator">=</span><span class="token string">&#39;rule family=ipv4 source address=192.168.2.0/24 port protocol=tcp port=60011 accept&#39;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>\u547D\u4EE4\u542B\u4E49\uFF1A</p><p>--zone #\u4F5C\u7528\u57DF</p><p>--add-port=80/tcp #\u6DFB\u52A0\u7AEF\u53E3\uFF0C\u683C\u5F0F\u4E3A\uFF1A\u7AEF\u53E3/\u901A\u8BAF\u534F\u8BAE</p><p>--permanent #\u6C38\u4E45\u751F\u6548\uFF0C\u6CA1\u6709\u6B64\u53C2\u6570\u91CD\u542F\u540E\u5931\u6548</p></blockquote><p>\u91CD\u542F\u9632\u706B\u5899</p><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code>firewall-cmd <span class="token parameter variable">--reload</span> 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>\u5E38\u7528\u547D\u4EE4\u4ECB\u7ECD</p><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code>firewall-cmd <span class="token parameter variable">--state</span>              <span class="token comment">##\u67E5\u770B\u9632\u706B\u5899\u72B6\u6001\uFF0C\u662F\u5426\u662Frunning</span>

firewall-cmd <span class="token parameter variable">--reload</span>              <span class="token comment">##\u91CD\u65B0\u8F7D\u5165\u914D\u7F6E\uFF0C\u6BD4\u5982\u6DFB\u52A0\u89C4\u5219\u4E4B\u540E\uFF0C\u9700\u8981\u6267\u884C\u6B64\u547D\u4EE4</span>
...
firewall-cmd --add-service<span class="token operator">=</span>ftp <span class="token parameter variable">--permanent</span>   <span class="token comment">##\u6C38\u4E45\u5F00\u653Eftp\u670D\u52A1</span>

firewall-cmd --remove-service<span class="token operator">=</span>ftp <span class="token parameter variable">--permanent</span>  <span class="token comment">##\u6C38\u4E45\u79FB\u9664ftp\u670D\u52A1</span>

firewall-cmd --add-port<span class="token operator">=</span><span class="token number">80</span>/tcp <span class="token parameter variable">--permanent</span>   <span class="token comment">##\u6C38\u4E45\u6DFB\u52A080\u7AEF\u53E3 </span>

firewall-cmd <span class="token parameter variable">--permanent</span> --add-rich-rule<span class="token operator">=</span><span class="token string">&#39;rule family=&quot;ipv4&quot; port protocol=&quot;tcp&quot; port=&quot;15672&quot; drop&#39;</span> <span class="token comment">#\u7981\u7528\u4E00\u4E2A\u7AEF\u53E3</span>

firewall-cmd <span class="token parameter variable">--permanent</span> <span class="token parameter variable">--zone</span><span class="token operator">=</span>trusted --add-source<span class="token operator">=</span><span class="token number">192.168</span>.2.0/24 <span class="token comment"># \u76F4\u63A5\u628A\u5185\u7F51\u7F51\u6BB5\u6DFB\u52A0\u4E3A\u53EF\u4FE1\u7F51\u6BB5</span>

iptables <span class="token parameter variable">-L</span> <span class="token parameter variable">-n</span>                 <span class="token comment">##\u67E5\u770B\u89C4\u5219\uFF0C\u8FD9\u4E2A\u547D\u4EE4\u662F\u548Ciptables\u7684\u76F8\u540C\u7684</span>

<span class="token function">man</span> firewall-cmd                <span class="token comment">##\u67E5\u770B\u5E2E\u52A9</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="iptables" tabindex="-1"><a class="header-anchor" href="#iptables" aria-hidden="true">#</a> Iptables</h3><blockquote><p>CentOS 7.0\u9ED8\u8BA4\u4F7F\u7528\u7684\u662Ffirewall\u4F5C\u4E3A\u9632\u706B\u5899\uFF0C\u4F7F\u7528iptables\u5FC5\u987B\u91CD\u65B0\u8BBE\u7F6E\u4E00\u4E0B</p></blockquote><h3 id="\u5E38\u7528\u89C4\u5219" tabindex="-1"><a class="header-anchor" href="#\u5E38\u7528\u89C4\u5219" aria-hidden="true">#</a> \u5E38\u7528\u89C4\u5219</h3><p>\u5148\u62D2\u7EDD\u6240\u6709\uFF0C\u518D\u5F00\u653E\u4E00\u4E2A\u7AEF\u53E3\u7ED9\u6307\u5B9Aip\u6216\u8005\u5730\u5740\u6BB5</p><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token function">sudo</span> iptables <span class="token parameter variable">-P</span> INPUT DROP <span class="token comment"># \u8FD9\u4E2A\u89C4\u5219\u6267\u884C\u540E\uFF0C\u73B0\u6709\u89C4\u5219\u4E0D\u4F1A\u5931\u6548\uFF0C\u4F46\u5176\u884C\u4E3A\u4F1A\u53D7\u5230\u9ED8\u8BA4\u7B56\u7565\u7684\u5F71\u54CD\u3002\u8FD9\u662F\u56E0\u4E3A\u9ED8\u8BA4\u7B56\u7565\u662F\u6240\u6709\u672A\u5339\u914D\u5230\u73B0\u6709\u89C4\u5219\u7684\u6D41\u91CF\u7684\u6700\u7EC8\u5904\u7406\u65B9\u5F0F\u3002</span>
<span class="token function">sudo</span> iptables <span class="token parameter variable">-I</span> INPUT <span class="token parameter variable">-s</span> <span class="token number">14.23</span>.97.250/192.168.2.0/24 <span class="token parameter variable">-p</span> tcp <span class="token parameter variable">--dport</span> <span class="token number">60011</span> <span class="token parameter variable">-j</span> ACCEPT
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>\u4FDD\u5B58\u89C4\u5219\u3001\u6062\u590D\u89C4\u5219</p><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token function">sudo</span> iptables-save <span class="token operator">&gt;</span> /etc/iptables/rules.v4
<span class="token function">sudo</span> iptables-restore <span class="token operator">&lt;</span> /etc/iptables/rules.v4
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>1\u3001\u76F4\u63A5\u5173\u95EDfirewalld\u9632\u706B\u5899</p><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code>systemctl stop firewalld.service      <span class="token comment">#\u505C\u6B62firewall</span>
systemctl disable firewalld.service   <span class="token comment">#\u7981\u6B62firewall\u5F00\u673A\u542F\u52A8</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>2\u3001\u8BBE\u7F6E iptables service</p><p>yum -y install iptables-services</p><p>\u5982\u679C\u8981\u4FEE\u6539\u9632\u706B\u5899\u914D\u7F6E\uFF0C\u5982\u589E\u52A0\u9632\u706B\u5899\u7AEF\u53E33306</p><p>vi /etc/sysconfig/iptables</p><p>\u589E\u52A0\u89C4\u5219</p><p>-A INPUT -m state --state NEW -m tcp -p tcp --dport 3306 -j ACCEPT</p><p>\u4FDD\u5B58\u9000\u51FA\u540E</p><p>systemctl restart iptables.service #\u91CD\u542F\u9632\u706B\u5899\u4F7F\u914D\u7F6E\u751F\u6548</p><p>systemctl enable iptables.service #\u8BBE\u7F6E\u9632\u706B\u5899\u5F00\u673A\u542F\u52A8</p><p>\u6700\u540E\u91CD\u542F\u7CFB\u7EDF\u4F7F\u8BBE\u7F6E\u751F\u6548\u5373\u53EF\u3002</p><p><strong>\u67E5\u770B</strong> <strong>SELinux<strong><strong>\u72B6\u6001\u53CA\u5173\u95ED</strong></strong>SELinux</strong></p><p>\u67E5\u770BSELinux\u72B6\u6001\uFF1A</p><p>1\u3001/usr/sbin/sestatus -v ##\u5982\u679CSELinux status\u53C2\u6570\u4E3Aenabled\u5373\u4E3A\u5F00\u542F\u72B6\u6001</p><p>SELinux status: enabled</p><p>2\u3001getenforce ##\u4E5F\u53EF\u4EE5\u7528\u8FD9\u4E2A\u547D\u4EE4\u68C0\u67E5</p><p>\u5173\u95EDSELinux\uFF1A</p><p>1\u3001\u4E34\u65F6\u5173\u95ED\uFF08\u4E0D\u7528\u91CD\u542F\u673A\u5668\uFF09\uFF1A</p><p>setenforce 0 ##\u8BBE\u7F6ESELinux \u6210\u4E3Apermissive\u6A21\u5F0F</p><p>\u200B ##setenforce 1 \u8BBE\u7F6ESELinux \u6210\u4E3Aenforcing\u6A21\u5F0F</p><p>2\u3001\u4FEE\u6539\u914D\u7F6E\u6587\u4EF6\u9700\u8981\u91CD\u542F\u673A\u5668\uFF1A</p><p>\u4FEE\u6539/etc/selinux/config \u6587\u4EF6</p><p>\u5C06SELINUX=enforcing\u6539\u4E3ASELINUX=disabled</p><p>\u91CD\u542F\u673A\u5668\u5373\u53EF</p><p><strong>iptables****\u914D\u7F6E</strong></p><p>\u67E5\u770Biptables\u914D\u7F6E\uFF1Aiptables -L -n</p><p>\u6DFB\u52A0\u5E38\u7528\u7AEF\u53E3\u89C4\u5219\uFF1A</p><p>#\u5141\u8BB8\u5BF9\u5916\u8BF7\u6C42\u7684\u8FD4\u56DE\u5305</p><p>iptables -A INPUT -m state --state RELATED,ESTABLISHED -j ACCEPT</p><p>#\u5141\u8BB8icmp\u5305\u901A\u8FC7</p><p>iptables -A INPUT -p icmp --icmp-type any -j ACCEPT</p><p>#\u5141\u8BB8\u6765\u81EA\u4E8Elo\u63A5\u53E3\u7684\u6570\u636E\u5305\uFF0C\u5982\u679C\u6CA1\u6709\u6B64\u89C4\u5219\uFF0C\u5C06\u4E0D\u80FD\u901A\u8FC7127.0.0.1\u8BBF\u95EE\u672C\u5730\u670D\u52A1</p><p>iptables -A INPUT -i lo -j ACCEPT</p><p>#\u7981\u6B62\u4E00\u4E2Aip\u6BB5</p><p>iptables -I INPUT -s 114.64.244.0/24 -j DROP</p><p>#\u5E38\u7528\u7AEF\u53E3</p><p>iptables -A INPUT -p tcp -m state --state NEW -m tcp --dport 21 -j ACCEPT</p><p>iptables -A INPUT -p tcp -m state --state NEW -m tcp --dport 22 -j ACCEPT</p><p>iptables -A INPUT -p tcp -m state --state NEW -m tcp --dport 23 -j ACCEPT</p><p>iptables -A INPUT -p tcp -m state --state NEW -m tcp --dport 80 -j ACCEPT</p><p>iptables -A INPUT -p tcp -m state --state NEW -m tcp --dport 443 -j ACCEPT</p><p>iptables -A INPUT -p tcp -m state --state NEW -m tcp --dport 3306 -j ACCEPT</p><p>iptables -A INPUT -p tcp -m state --state NEW -m tcp --dport 8080 -j ACCEPT</p><p>#\u8FC7\u6EE4\u6240\u6709\u975E\u4EE5\u4E0A\u89C4\u5219\u7684\u8BF7\u6C42</p><p>iptables -P INPUT DROP</p><p>#\u5982\u679C\u8981\u6DFB\u52A0\u5185\u7F51ip\u4FE1\u4EFB\uFF08\u63A5\u53D7\u5176\u6240\u6709TCP\u8BF7\u6C42\uFF09</p><p>#\u6CE8\uFF1A(<strong>.</strong>.<strong>.</strong>)\u4E3AIP,\u4E0B\u540C</p><p>iptables -A INPUT -p tcp -s <strong>.</strong>.<strong>.</strong> -j ACCEPT</p><p>#\u8981\u5C01\u505C\u4E00\u4E2AIP\uFF0C\u4F7F\u7528\u4E0B\u9762\u8FD9\u6761\u547D\u4EE4</p><p>iptables -I INPUT -s <strong>.</strong>.<strong>.</strong> -j DROP</p><p>#\u8981\u89E3\u5C01\u4E00\u4E2AIP\uFF0C\u4F7F\u7528\u4E0B\u9762\u8FD9\u6761\u547D\u4EE4</p><p>iptables -D INPUT -s <strong>.</strong>.<strong>.</strong> -j DROP</p><p>\u4FDD\u5B58\u91CD\u542F\u9632\u706B\u5899</p><p>/etc/init.d/iptables save</p><p>service iptables restart</p><p>\u5176\u4ED6\u5E38\u7528\u547D\u4EE4\uFF08\u4E0D\u662F\u4E00\u5B9A\u8981\u505A\uFF09</p><p>#\u5141\u8BB8\u6240\u6709\u5165\u6808\u89C4\u5219</p><p>iptables -P INPUT ACCEPT</p><p>#\u6E05\u7A7A\u9ED8\u8BA4\u6240\u6709\u89C4\u5219</p><p>iptables -F</p><p>#\u6E05\u7A7A\u81EA\u5B9A\u4E49\u7684\u6240\u6709\u89C4\u5219</p><p>iptables -X</p><p>#\u8BA1\u6570\u5668\u7F6E0</p><p>iptables -Z</p><p>\u5173\u95ED\u7AEF\u53E3</p><p>\u5E38\u7528\u5220\u9664\u7AEF\u53E3\u89C4\u5219</p><p># \u67E5\u770B\u5F53\u524D\u7AEF\u53E3\u6240\u5728\u884C\u6570</p><p>iptables -L -n --line-number</p><p># \u5220\u9664\u6307\u5B9A\u5E8F\u5217\u7684\u7AEF\u53E3\uFF08\u4E0B\u9762\u662F\u5220\u9664\u7B2C\u4E94\u6761\u7AEF\u53E3\uFF09</p><p>iptables -D INPUT 5</p><p># \u786E\u8BA4\u662F\u5426\u5DF2\u7ECF\u5220\u9664\uFF0C\u53EF\u4EE5\u91CD\u65B0\u67E5\u770B\u5217\u8868</p><p>iptables -L -n --line-number</p><h2 id="debian" tabindex="-1"><a class="header-anchor" href="#debian" aria-hidden="true">#</a> debian</h2><blockquote><p>debian\u7BA1\u7406iptables\u9700\u8981\u7528\u5230iptables-persistent \uFF0C\u6216\u8005ufw</p><p>\u901A\u8FC7iptables-persistent\u751F\u6210\u7684\u89C4\u5219\u9ED8\u8BA4\u5C06\u88AB\u5B58\u50A8\u5728\u4EE5\u4E0B\u6587\u4EF6\u4E2D</p><p>/etc/iptables/rules.v4 /etc/iptables/rules.v6</p></blockquote><h3 id="\u5B89\u88C5iptables-persistent\u6765\u4F7F\u7528iptables\u547D\u4EE4" tabindex="-1"><a class="header-anchor" href="#\u5B89\u88C5iptables-persistent\u6765\u4F7F\u7528iptables\u547D\u4EE4" aria-hidden="true">#</a> \u5B89\u88C5iptables-persistent\u6765\u4F7F\u7528iptables\u547D\u4EE4</h3><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">apt</span> <span class="token function">install</span> iptables-persistent <span class="token parameter variable">-y</span>
...
<span class="token function">service</span> iptables save
<span class="token function">service</span> sshd restart
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="\u5B8C\u5168\u91CD\u5EFA-docker-\u9632\u706B\u5899\u89C4\u5219" tabindex="-1"><a class="header-anchor" href="#\u5B8C\u5168\u91CD\u5EFA-docker-\u9632\u706B\u5899\u89C4\u5219" aria-hidden="true">#</a> \u5B8C\u5168\u91CD\u5EFA Docker \u9632\u706B\u5899\u89C4\u5219</h3><h4 id="_1-\u505C\u6B62-docker-\u670D\u52A1" tabindex="-1"><a class="header-anchor" href="#_1-\u505C\u6B62-docker-\u670D\u52A1" aria-hidden="true">#</a> 1. <strong>\u505C\u6B62 Docker \u670D\u52A1</strong></h4><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token function">sudo</span> systemctl stop <span class="token function">docker</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="_2-\u6E05\u9664\u6240\u6709\u6B8B\u7559\u89C4\u5219" tabindex="-1"><a class="header-anchor" href="#_2-\u6E05\u9664\u6240\u6709\u6B8B\u7559\u89C4\u5219" aria-hidden="true">#</a> 2. <strong>\u6E05\u9664\u6240\u6709\u6B8B\u7559\u89C4\u5219</strong></h4><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token function">sudo</span> iptables <span class="token parameter variable">-F</span>
...
<span class="token function">sudo</span> iptables <span class="token parameter variable">-X</span>  <span class="token comment"># \u5220\u9664\u81EA\u5B9A\u4E49\u94FE</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_3-\u6062\u590D\u9ED8\u8BA4\u7B56\u7565" tabindex="-1"><a class="header-anchor" href="#_3-\u6062\u590D\u9ED8\u8BA4\u7B56\u7565" aria-hidden="true">#</a> 3. <strong>\u6062\u590D\u9ED8\u8BA4\u7B56\u7565</strong></h4><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token function">sudo</span> iptables <span class="token parameter variable">-P</span> INPUT ACCEPT
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_4-\u91CD\u542F-docker-\u81EA\u52A8\u751F\u6210\u89C4\u5219" tabindex="-1"><a class="header-anchor" href="#_4-\u91CD\u542F-docker-\u81EA\u52A8\u751F\u6210\u89C4\u5219" aria-hidden="true">#</a> 4. <strong>\u91CD\u542F Docker \u81EA\u52A8\u751F\u6210\u89C4\u5219</strong></h4><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token function">sudo</span> systemctl start <span class="token function">docker</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,136),p=[l];function t(r,c){return a(),n("div",null,p)}var v=s(i,[["render",t],["__file","\u9632\u706B\u5899.html.vue"]]);export{v as default};
