import{_ as t}from"./plugin-vue_export-helper.21dcd24c.js";import{o as i,c as l,a as n,b as o,e as a,d as s,r as p}from"./app.1d4c3584.js";const c={},u=a(`<h1 id="mongo" tabindex="-1"><a class="header-anchor" href="#mongo" aria-hidden="true">#</a> mongo</h1><h3 id="docker\u521B\u5EFAmongo\u670D\u52A1" tabindex="-1"><a class="header-anchor" href="#docker\u521B\u5EFAmongo\u670D\u52A1" aria-hidden="true">#</a> docker\u521B\u5EFAmongo\u670D\u52A1</h3><blockquote><p>\u76EE\u5F55\u7ED3\u6784</p><p>./ \u251C\u2500\u2500 data \u251C\u2500\u2500 docker-compose.yml \u251C\u2500\u2500 logs</p></blockquote><p>docker-compose.yml\u6587\u4EF6\uFF1A</p><div class="language-yaml ext-yml line-numbers-mode"><pre class="language-yaml"><code><span class="token key atrule">version</span><span class="token punctuation">:</span> <span class="token string">&#39;3.8&#39;</span>

<span class="token key atrule">services</span><span class="token punctuation">:</span>
  <span class="token key atrule">mongodb</span><span class="token punctuation">:</span>
    <span class="token key atrule">image</span><span class="token punctuation">:</span> mongo<span class="token punctuation">:</span>6.0.22
    <span class="token key atrule">container_name</span><span class="token punctuation">:</span> mongodb_6
    <span class="token key atrule">restart</span><span class="token punctuation">:</span> unless<span class="token punctuation">-</span>stopped
    <span class="token key atrule">ports</span><span class="token punctuation">:</span>
      <span class="token punctuation">-</span> <span class="token string">&quot;192.168.2.135:27017:27017&quot;</span>
    <span class="token key atrule">volumes</span><span class="token punctuation">:</span>
      <span class="token punctuation">-</span> ./data<span class="token punctuation">:</span>/data/db
      <span class="token punctuation">-</span> ./logs<span class="token punctuation">:</span>/var/log/mongodb
    <span class="token key atrule">environment</span><span class="token punctuation">:</span>
      <span class="token comment"># \u7CFB\u7EDF\u65E5\u5FD7\u914D\u7F6E</span>
      <span class="token punctuation">-</span> MONGO_INITDB_SYSTEM_LOG_DESTINATION=file
      <span class="token punctuation">-</span> MONGO_INITDB_SYSTEM_LOG_PATH=/var/log/mongodb/mongod.log
      <span class="token punctuation">-</span> MONGO_INITDB_SYSTEM_LOG_LOGAPPEND=true
      <span class="token punctuation">-</span> MONGO_INITDB_SYSTEM_LOG_TIMESTAMPFORMAT=iso8601<span class="token punctuation">-</span>utc

      <span class="token comment"># \u5B58\u50A8\u5F15\u64CE\u914D\u7F6E</span>
      <span class="token punctuation">-</span> MONGO_INITDB_STORAGE_ENGINE=wiredTiger
      <span class="token punctuation">-</span> MONGO_INITDB_WIREDTIGER_CACHE_SIZE_GB=2
      <span class="token punctuation">-</span> MONGO_INITDB_WIREDTIGER_DIRECTORY_FOR_INDEXES=true
      <span class="token punctuation">-</span> MONGO_INITDB_WIREDTIGER_COLLECTION_BLOCK_COMPRESSOR=zlib
      <span class="token punctuation">-</span> MONGO_INITDB_WIREDTIGER_INDEX_PREFIX_COMPRESSION=true 

      <span class="token comment"># \u7F51\u7EDC\u914D\u7F6E</span>
      <span class="token punctuation">-</span> MONGO_INITDB_NET_PORT=27017
      <span class="token punctuation">-</span> MONGO_INITDB_NET_BIND_IP=0.0.0.0
      <span class="token punctuation">-</span> MONGO_INITDB_NET_MAX_INCOMING_CONNECTIONS=20000 

      <span class="token comment"># \u6027\u80FD\u5206\u6790</span>
      <span class="token punctuation">-</span> MONGO_INITDB_OPERATION_PROFILING_MODE=slowOp
      <span class="token punctuation">-</span> MONGO_INITDB_OPERATION_PROFILING_SLOW_OP_THRESHOLD_MS=1000
      <span class="token punctuation">-</span> TZ=Asia/Shanghai

      <span class="token comment"># \u96C6\u7FA4\u8282\u70B9\u53D1\u73B0\u914D\u7F6E\uFF08\u9700\u66FF\u6362\u5B9E\u9645IP\uFF09</span>
      <span class="token punctuation">-</span> MONGO_INITDB_CLUSTER_IP_OVERRIDE=192.168.2.135
      <span class="token punctuation">-</span> MONGO_INITDB_REPL_SET_HOSTS=192.168.2.135<span class="token punctuation">:</span><span class="token number">27017</span><span class="token punctuation">,</span>192.168.2.139<span class="token punctuation">:</span><span class="token number">27017</span><span class="token punctuation">,</span>192.168.2.139<span class="token punctuation">:</span><span class="token number">27018</span>
    ...
    <span class="token key atrule">logging</span><span class="token punctuation">:</span>
      ...
      <span class="token key atrule">options</span><span class="token punctuation">:</span>
        <span class="token key atrule">max-size</span><span class="token punctuation">:</span> <span class="token string">&quot;500m&quot;</span>
    ...
    <span class="token key atrule">command</span><span class="token punctuation">:</span> <span class="token punctuation">[</span>
      <span class="token string">&quot;--replSet=jobui&quot;</span><span class="token punctuation">,</span>
      <span class="token string">&quot;--bind_ip_all&quot;</span><span class="token punctuation">,</span>
      <span class="token string">&quot;--directoryperdb&quot;</span><span class="token punctuation">,</span>
      <span class="token string">&quot;--journal&quot;</span><span class="token punctuation">,</span>
      <span class="token string">&quot;--oplogSize=20480&quot;</span><span class="token punctuation">,</span>
      <span class="token comment"># \u5B89\u5168\u914D\u7F6E\uFF08\u5982\u9700\u542F\u7528\uFF09</span>
      <span class="token comment"># &quot;--auth&quot;,</span>
      <span class="token comment"># TLS\u914D\u7F6E\u793A\u4F8B\uFF08\u9700\u6302\u8F7D\u8BC1\u4E66\uFF09</span>
      <span class="token comment"># &quot;--tlsMode=requireTLS&quot;,</span>
      <span class="token comment"># &quot;--tlsCertificateKeyFile=/etc/ssl/mongodb.pem&quot;,</span>
      <span class="token comment"># &quot;--tlsCAFile=/etc/ssl/ca.pem&quot;</span>
    ...
    <span class="token key atrule">healthcheck</span><span class="token punctuation">:</span>
      <span class="token key atrule">test</span><span class="token punctuation">:</span> echo &#39;db.runCommand(&quot;ping&quot;).ok&#39; <span class="token punctuation">|</span> mongosh <span class="token punctuation">-</span><span class="token punctuation">-</span>quiet <span class="token punctuation">|</span><span class="token punctuation">|</span> exit 1
      <span class="token key atrule">interval</span><span class="token punctuation">:</span> 30s
      <span class="token key atrule">timeout</span><span class="token punctuation">:</span> 10s
      <span class="token key atrule">retries</span><span class="token punctuation">:</span> <span class="token number">3</span>
<span class="token key atrule">volumes</span><span class="token punctuation">:</span>
  <span class="token key atrule">mongodb_data</span><span class="token punctuation">:</span>
    <span class="token key atrule">driver</span><span class="token punctuation">:</span> local
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="\u670D\u52A1\u914D\u7F6E" tabindex="-1"><a class="header-anchor" href="#\u670D\u52A1\u914D\u7F6E" aria-hidden="true">#</a> \u670D\u52A1\u914D\u7F6E</h3><h4 id="\u914D\u7F6E\u590D\u5236\u96C6" tabindex="-1"><a class="header-anchor" href="#\u914D\u7F6E\u590D\u5236\u96C6" aria-hidden="true">#</a> \u914D\u7F6E\u590D\u5236\u96C6</h4><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token comment"># \u8FDE\u63A5</span>
<span class="token function">docker</span> <span class="token builtin class-name">exec</span> <span class="token parameter variable">-it</span> mongodb_6 mongosh
<span class="token comment"># \u521D\u59CB\u5316\uFF08\u5355\u4E2A\u8282\u70B9\uFF09</span>
...
<span class="token comment"># \u521D\u59CB\u5316\u5168\u90E8\u8282\u70B9</span>
rs.initiate<span class="token punctuation">(</span><span class="token punctuation">{</span>  _id: <span class="token string">&quot;jobui&quot;</span>,  members: <span class="token punctuation">[</span>    <span class="token punctuation">{</span> _id: <span class="token number">0</span>, host: <span class="token string">&quot;192.168.2.135:27017&quot;</span>, priority: <span class="token number">2</span> <span class="token punctuation">}</span>,    <span class="token punctuation">{</span> _id: <span class="token number">1</span>, host: <span class="token string">&quot;192.168.2.139:27017&quot;</span>, priority: <span class="token number">1</span> <span class="token punctuation">}</span>,    <span class="token punctuation">{</span> _id: <span class="token number">2</span>, host: <span class="token string">&quot;192.168.2.139:27018&quot;</span>, arbiterOnly: <span class="token boolean">true</span> <span class="token punctuation">}</span>  <span class="token punctuation">]</span>,  settings: <span class="token punctuation">{</span>    chainingAllowed: true,    heartbeatIntervalMillis: <span class="token number">2000</span>,    electionTimeoutMillis: <span class="token number">10000</span>  <span class="token punctuation">}</span> <span class="token punctuation">}</span><span class="token punctuation">)</span>
...
<span class="token comment"># \u62A5\u9519\u89E3\u51B3\uFF1AMongoServerError[NewReplicaSetConfigurationIncompatible]: Reconfig attempted to install a config that would change the implicit default write concern. Use the setDefaultRWConcern command to set a cluster-wide write concern and try the reconfig again.</span>
db.adminCommand<span class="token punctuation">(</span><span class="token punctuation">{</span>
  <span class="token string">&quot;setDefaultRWConcern&quot;</span> <span class="token builtin class-name">:</span> <span class="token number">1</span>,
  <span class="token string">&quot;defaultWriteConcern&quot;</span> <span class="token builtin class-name">:</span> <span class="token punctuation">{</span>
    <span class="token string">&quot;w&quot;</span> <span class="token builtin class-name">:</span> <span class="token number">2</span>
  <span class="token punctuation">}</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="\u5173\u95ED\u547D\u4EE4" tabindex="-1"><a class="header-anchor" href="#\u5173\u95ED\u547D\u4EE4" aria-hidden="true">#</a> \u5173\u95ED\u547D\u4EE4</h4><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code>db.shutdownServer<span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="\u96C6\u7FA4\u65E0\u6CD5\u9009\u4E3E\u5904\u7406" tabindex="-1"><a class="header-anchor" href="#\u96C6\u7FA4\u65E0\u6CD5\u9009\u4E3E\u5904\u7406" aria-hidden="true">#</a> \u96C6\u7FA4\u65E0\u6CD5\u9009\u4E3E\u5904\u7406</h3><blockquote><p>\u65E0\u6CD5\u5728secondary\u4E0A\u6267\u884C\u547D\u4EE4\uFF0C\u90A3\u4E48\u8FD9\u79CD\u60C5\u51B5\u4E0B\uFF0C\u5982\u4F55\u4F7F\u7528force\u547D\u4EE4\u6765\u6E05\u7406\u914D\u7F6E\u5462\uFF1F</p></blockquote><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code>SECONDARY<span class="token operator">&gt;</span> <span class="token assign-left variable">cfg</span><span class="token operator">=</span>rs.conf<span class="token punctuation">(</span><span class="token punctuation">)</span>
SECONDARY<span class="token operator">&gt;</span> cfg.members.splice<span class="token punctuation">(</span><span class="token number">2,1</span><span class="token punctuation">)</span>  <span class="token comment"># \u4ECE\u4E0B\u68072\u7684\u8282\u70B9\u5F00\u59CB\uFF0C\u5220\u96641\u4E2A\u8282\u70B9\u914D\u7F6E</span>
SECONDARY<span class="token operator">&gt;</span> rs.reconfig<span class="token punctuation">(</span>cfg,<span class="token punctuation">{</span>force:true<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="docker\u96C6\u7FA4\u542F\u52A8\u6CE8\u610F\u4E8B\u9879" tabindex="-1"><a class="header-anchor" href="#docker\u96C6\u7FA4\u542F\u52A8\u6CE8\u610F\u4E8B\u9879" aria-hidden="true">#</a> docker\u96C6\u7FA4\u542F\u52A8\u6CE8\u610F\u4E8B\u9879</h3><blockquote><p>docker\u542F\u52A8\u7684\u96C6\u7FA4\uFF0C\u521D\u59CB\u5316\u7684\u65F6\u5019\u8981\u4F7F\u7528\u5BBF\u4E3B\u673Aip\u521D\u59CB\u5316</p></blockquote><div class="language-javascript ext-js line-numbers-mode"><pre class="language-javascript"><code>rs<span class="token punctuation">.</span><span class="token function">initiate</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
  ...
  <span class="token literal-property property">members</span><span class="token operator">:</span> <span class="token punctuation">[</span>
    <span class="token punctuation">{</span> <span class="token literal-property property">_id</span><span class="token operator">:</span> <span class="token number">0</span><span class="token punctuation">,</span> <span class="token literal-property property">host</span><span class="token operator">:</span> <span class="token string">&#39;192.168.1.100:27017&#39;</span> <span class="token punctuation">}</span><span class="token punctuation">,</span> <span class="token comment">// \u4E3B\u5E93 IP</span>
    <span class="token punctuation">{</span> <span class="token literal-property property">_id</span><span class="token operator">:</span> <span class="token number">1</span><span class="token punctuation">,</span> <span class="token literal-property property">host</span><span class="token operator">:</span> <span class="token string">&#39;192.168.1.55:27017&#39;</span> <span class="token punctuation">}</span>   <span class="token comment">// \u4ECE\u5E93 IP</span>
  <span class="token punctuation">]</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>\u5982\u679C\u5DF2\u7ECF\u521D\u59CB\u5316\u4E86\uFF0C\u53EF\u4EE5\u901A\u8FC7\u4FEE\u6539\u914D\u7F6E\u6587\u4EF6\u6765\u89E3\u51B3</p></blockquote><div class="language-javascript ext-js line-numbers-mode"><pre class="language-javascript"><code>cfg <span class="token operator">=</span> rs<span class="token punctuation">.</span><span class="token function">conf</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
cfg<span class="token punctuation">.</span>members<span class="token punctuation">[</span><span class="token number">0</span><span class="token punctuation">]</span><span class="token punctuation">.</span>host <span class="token operator">=</span> <span class="token string">&quot;192.168.1.100:27017&quot;</span><span class="token punctuation">;</span> <span class="token comment">// \u66FF\u6362\u6210\u4E3B\u5E93\u5B9E\u9645 IP</span>
rs<span class="token punctuation">.</span><span class="token function">reconfig</span><span class="token punctuation">(</span>cfg<span class="token punctuation">,</span> <span class="token punctuation">{</span> <span class="token literal-property property">force</span><span class="token operator">:</span> <span class="token boolean">true</span> <span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="\u521B\u5EFA\u7528\u6237" tabindex="-1"><a class="header-anchor" href="#\u521B\u5EFA\u7528\u6237" aria-hidden="true">#</a> \u521B\u5EFA\u7528\u6237</h3><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token comment">#\u8FDB\u53BBmongo\u540E\u5207\u6362\u5230admin\u5E93</span>
use admin
...
<span class="token variable"><span class="token variable">\`</span>db.dropDatabase<span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token variable">\`</span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="\u5BFC\u51FA\u6570\u636E\u5E93" tabindex="-1"><a class="header-anchor" href="#\u5BFC\u51FA\u6570\u636E\u5E93" aria-hidden="true">#</a> \u5BFC\u51FA\u6570\u636E\u5E93</h3><blockquote><p>\u4F7F\u7528--oplog\u4E0D\u9501\u5E93\uFF0C\u8FD8\u53EF\u4EE5\u4ECE\u65E5\u5FD7\u8BB0\u5F55\u5F00\u59CB\u8FFD\u52A0\u589E\u91CF\u6570\u636E --gzip\u53C2\u6570\u662F\u538B\u7F29\u6570\u636E</p></blockquote><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code>mongodump <span class="token parameter variable">-h</span> <span class="token number">192.168</span>.1.35:12000 <span class="token parameter variable">-d</span> jobui_tmp <span class="token parameter variable">-o</span> /ssd_data/mongobackups/
or
<span class="token function">docker</span> <span class="token builtin class-name">exec</span> <span class="token parameter variable">-it</span> mongodb_12000 /usr/local/mongodb-3.0.7/bin/mongodump <span class="token parameter variable">--host</span> <span class="token number">192.168</span>.2.135 <span class="token parameter variable">--port</span> <span class="token number">12000</span> <span class="token parameter variable">--db</span> jobui_syscache <span class="token parameter variable">--out</span> bak/

/web/software/mongodb-3.0.7/bin/mongodump <span class="token parameter variable">--host</span> <span class="token number">192.168</span>.2.135 <span class="token parameter variable">--port</span> <span class="token number">12000</span> <span class="token parameter variable">--oplog</span> <span class="token parameter variable">--gzip</span> <span class="token parameter variable">--out</span> dump3
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="\u5BFC\u5165\u6570\u636E" tabindex="-1"><a class="header-anchor" href="#\u5BFC\u5165\u6570\u636E" aria-hidden="true">#</a> \u5BFC\u5165\u6570\u636E</h3><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token function">docker</span> <span class="token builtin class-name">exec</span> <span class="token parameter variable">-it</span> mongodb_12000 /usr/local/mongodb-3.0.7/bin/mongorestore <span class="token parameter variable">--host</span> <span class="token number">192.168</span>.2.135 <span class="token parameter variable">--port</span> <span class="token number">12000</span> <span class="token parameter variable">--db</span> jobui_syscache bak/
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="mongodb\u5347\u7EA7\u7248\u672C" tabindex="-1"><a class="header-anchor" href="#mongodb\u5347\u7EA7\u7248\u672C" aria-hidden="true">#</a> mongodb\u5347\u7EA7\u7248\u672C</h3><blockquote><p>3.0.7 -&gt; 6.0.22</p><p>\u7248\u672C\u5DEE\u5F02\u5927\u6EDA\u52A8\u5347\u7EA7\u592A\u8D39\u65F6\u95F4</p><p>\u8FC1\u79FB\u601D\u8DEF\uFF1A\u57283.0\u673A\u5668\u5EFA\u7ACB\u4E00\u4E2A6.0\u65B0\u96C6\u7FA4\uFF0C\u4F7F\u7528mongodump\u5BFC\u51FA\u6570\u636E\u540Emongorestore\u5BFC\u5165\u65B0\u96C6\u7FA4\uFF0C\u8282\u7701\u6570\u636E\u4F20\u8F93\u65F6\u95F4\u3002</p><p>ps \uFF1A\u5E26--oplog\u53C2\u6570\u624D\u80FD\u8BB0\u5F55\u5BFC\u51FA\u65F6\u5019\u7684\u53D8\u66F4\u4EE5\u53CA\u5BFC\u51FA\u65F6\u95F4 --gzip \u53C2\u6570\u662F\u538B\u7F29\uFF0C3.0.7\u7248\u672C\u6CA1\u6709\u8FD9\u4E2A\uFF0C\u9AD8\u7248\u672C\u53EF\u4EE5\u7528</p></blockquote><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token comment"># \u7B2C\u4E00\u6B65\uFF1A\u4F7F\u7528 mongodump \u5BFC\u51FA\u6570\u636E + oplog</span>
mongodump <span class="token parameter variable">--host</span> <span class="token operator">&lt;</span>source_host<span class="token operator">&gt;</span> <span class="token parameter variable">--out</span> /mongo_bak/dump3 <span class="token parameter variable">--oplog</span>

<span class="token comment"># \u5206\u5E93\u5BFC\u5165\u6570\u636E\uFF08\u6700\u597D\u4E0D\u8981\u8FD9\u6837\u64CD\u4F5C\uFF0C\u4E0D\u7136oplog\u56DE\u653E\u7684\u65F6\u5019\u4F1A\u62A5\u9519\uFF09</span>
mongorestore <span class="token parameter variable">--dir</span> /mongo_bak/dump3 <span class="token parameter variable">--nsInclude</span><span class="token operator">=</span><span class="token string">&quot;jobui_companyContent.*&quot;</span>
mongorestore <span class="token parameter variable">--dir</span> /mongo_bak/dump3 <span class="token parameter variable">--nsInclude</span><span class="token operator">=</span><span class="token string">&quot;jobui_jobInfo.*&quot;</span>
<span class="token comment"># ...</span>

<span class="token comment"># \u7B2C\u4E8C\u6B65\uFF1A\u5728\u65B0\u5E93\u6267\u884Coplog\u56DE\u653E\u5BFC\u5165\u6570\u636E</span>
mongorestore <span class="token parameter variable">--dir</span> /mongo_bak/dump3 <span class="token parameter variable">--oplogReplay</span>

<span class="token comment"># \u7B2C\u4E09\u6B65\uFF1A\u589E\u91CF\u5BFC\u51FA</span>
<span class="token comment"># 1. \u8BB0\u5F55\u5168\u91CF\u5BFC\u51FA\u7ED3\u675F\u65F6\u7684oplog\u4F4D\u7F6E\uFF08\u8FD9\u4E2A\u65B9\u6CD5\u4EC5\u4EC5\u9002\u7528\u4E8E\u5BFC\u51FA\u6570\u636E\u91CF\u4E0D\u591A\u7684\u60C5\u51B5\u4E0D\u7136\u4F1A\u5F88\u6162\uFF0C\u5927\u6570\u636E\u91CF\u76F4\u63A5\u5199\u4E2Apython\u811A\u672C\u8BFB\uFF09</span>
bsondump /mongo_bak/dump1/oplog.bson <span class="token operator">|</span> <span class="token function">tail</span> <span class="token parameter variable">-n</span> <span class="token number">1</span>

<span class="token comment"># \u8F93\u51FA\u793A\u4F8B\uFF08\u8BB0\u4E0B\u6B64\u503C\uFF09\uFF1A</span>
<span class="token comment"># { &quot;ts&quot;: { &quot;$timestamp&quot;: { &quot;t&quot;: 1744860937, &quot;i&quot;: 75 } } }</span>

<span class="token comment"># 2. \u505C\u6B62mongo\u5199\u5165</span>
db.fsyncLock<span class="token punctuation">(</span><span class="token punctuation">)</span>

<span class="token comment"># 3. \u6267\u884C\u589E\u91CF\u5BFC\u51FA\uFF08\u4EC5\u5BFC\u51FA\u6B64\u65F6\u95F4\u70B9\u4E4B\u540E\u7684\u53D8\u66F4\uFF09</span>
mongodump <span class="token parameter variable">--host</span> <span class="token number">192.168</span>.2.135 <span class="token parameter variable">--port</span> <span class="token number">12000</span> <span class="token punctuation">\\</span>
  <span class="token parameter variable">-d</span> <span class="token builtin class-name">local</span> <span class="token parameter variable">-c</span> oplog.rs <span class="token punctuation">\\</span>
  <span class="token parameter variable">-q</span> <span class="token string">&#39;{&quot;ts&quot;: {&quot;$gt&quot;: {&quot;$timestamp&quot;: {&quot;t&quot;: 1744860937, &quot;i&quot;: 75}}}}&#39;</span> <span class="token punctuation">\\</span>
  <span class="token parameter variable">--out</span> /tmp/dump_increment_raw
<span class="token comment"># \u7B2C\u516D\u6B65\uFF1A\u4ECE\u65B0\u7684oplog\u5BFC\u5165\u540E\u5207\u6362\u6570\u636E\u5E93\u8FDE\u63A5</span>
mongorestore <span class="token parameter variable">--dir</span> /backup/incremental <span class="token parameter variable">--oplogReplay</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="\u65B0\u589E\u5B50\u6587\u6863" tabindex="-1"><a class="header-anchor" href="#\u65B0\u589E\u5B50\u6587\u6863" aria-hidden="true">#</a> \u65B0\u589E\u5B50\u6587\u6863</h3><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code>db.mapping.update<span class="token punctuation">(</span>
    <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="\u521B\u5EFA\u7D22\u5F15" tabindex="-1"><a class="header-anchor" href="#\u521B\u5EFA\u7D22\u5F15" aria-hidden="true">#</a> \u521B\u5EFA\u7D22\u5F15</h3><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code><span class="token comment">#\u8BED\u6CD5\u4E2D Key \u503C\u4E3A\u4F60\u8981\u521B\u5EFA\u7684\u7D22\u5F15\u5B57\u6BB5\uFF0C1 \u4E3A\u6307\u5B9A\u6309\u5347\u5E8F\u521B\u5EFA\u7D22\u5F15\uFF0C\u5982\u679C\u4F60\u60F3\u6309\u964D\u5E8F\u6765\u521B\u5EFA\u7D22\u5F15\u6307\u5B9A\u4E3A -1 \u5373\u53EF\u3002</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>h</p><p>// \u8FDE\u63A5\u5230\u5065\u5EB7\u7684 SECONDARY \u8282\u70B9\uFF08\u5982 192.168.2.135\uFF09 docker exec -it mongodb_12000 mongo --host 192.168.2.135 --port 12000</p><p>// \u5F3A\u5236\u8BE5\u8282\u70B9\u53C2\u4E0E\u9009\u4E3E\uFF08\u5173\u952E\u6B65\u9AA4\uFF09 db.adminCommand({ replSetReconfig: { _id: &quot;jobui&quot;, version: rs.conf().version + 1, members: [ { _id: 19, host: &quot;192.168.2.132:12000&quot;, arbiterOnly: true }, { _id: 31, host: &quot;192.168.2.135:12000&quot;, priority: 2 }, // \u63D0\u9AD8\u4F18\u5148\u7EA7 { _id: 32, host: &quot;192.168.2.139:12000&quot;, priority: 0 } // \u6682\u65F6\u7981\u7528 ] }, force: true // \u5F3A\u5236\u5E94\u7528\u914D\u7F6E })</p><p>// \u89E3\u9664\u8282\u70B9\u51BB\u7ED3\u72B6\u6001\uFF08\u786E\u4FDD\u80FD\u53C2\u4E0E\u9009\u4E3E\uFF09 db.adminCommand({replSetFreeze: 0})</p>`,82);function q(h,f){const e=p("ExternalLinkIcon");return i(),l("div",null,[u,n("h5",d,[r,v,n("a",m,[b,o(e)]),k]),g])}var _=t(c,[["render",q],["__file","mongo.html.vue"]]);export{_ as default};
